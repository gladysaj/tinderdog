    ...
    <div>
      ...
      >
        <div className=" uk-container uk-first-column uk-card-body">
          <img src={image || "https://cdn.pixabay.com/photo/2017/06/13/12/53/profile-2398782_1280.png"} alt="profile picture" className="bg-img" />
        </div>
        <div>
          <div className="uk-card-body uk-container">
            ...
            <p className="uk-text-justify">{description || "Add a description..."}</p>
          </div>
        </div>
      </div>
    </div>
